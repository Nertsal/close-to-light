...
//         groups_path: PathBuf::from("test_groups"), // TODO: idk
//     };
...
//     // Create level
//     let request = Request::post("levels/create/").context("when constructing a request")?;
...
//             player: PlayerInfo {
//                 id: player.id,
//                 name: "nert".to_string(), // Change name
//             },
//             score: 5,
...
//         .await?
//         .call(request_json(
//             Request::post(format!("/levels/{}/scores/", level_id))
