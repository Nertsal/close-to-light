...
- **Wishlist** [on Steam](https://store.steampowered.com/app/4209820/Close_to_Light/)!
...
Made by [Nertsal](https://nertsal.itch.io/) in [Rust](https://www.rust-lang.org/) with [geng](https://github.com/geng-engine/geng).

Jam version visuals, music, and level design by [IcyLava](https://icy-lava.itch.io/).

Original idea by [kuviman](https://kuviman.itch.io/), inspired by [close to line](https://icy-lava.itch.io/close-to-line).
